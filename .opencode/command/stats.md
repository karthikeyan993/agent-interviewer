---
description: View weekly progress dashboard (project)
---
...
2. Read `data/stats-cache.json` (pre-computed stats)

3. Read `data/goals.json` for weekly target

4. Display dashboard using cached values:
